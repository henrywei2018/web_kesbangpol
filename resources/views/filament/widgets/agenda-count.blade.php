...
<div class="rounded-xl shadow border border-stroke bg-white px-7.5 py-4 shadow-default dark:border-strokedark dark:bg-boxdark">
    ...
    <div class="mt-4 mx-6 flex items-end justify-between">
        <div>
            ...
            <span class="text-md font-medium">Total Sidang</span>
        </div>
    </div>
</div>
