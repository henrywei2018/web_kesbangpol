...
<body>
    ...
    <div class="content">
        ...
        <p style="text-align: center; margin-left: 20mm;">Nomor : 094/{{ $skt->id ?? 'N/A' }}/KESBANGPOL-set/SKT/{{ now()->format('Y') }}
        ...
        <table width="100%" cellspacing="5" cellpadding="0" id="detail" style="margin-top: 7mm;">
            <tbody>
                <tr>
                    ...
                    <td width="77%" style="text-transform: uppercase">{{ $skt->nama_organisasi ?? 'N/A' }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top">:</td>
                    <td>Ketua : {{ $skt->nama_ketua ?? 'N/A' }}<br>
                        Sekretaris : -<br>
                        Bendahara : -<br>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td valign="top">:</td>
                    <td>{{ $skt->id ?? 'N/A' }}/{{ $skt->created_at->format('dmY') ?? 'N/A' }}</td>
                </tr>
