                    ...
                    <div class="col-md-12 align-self-center p-static text-center">
                        <div class="overflow-hidden mb-2">
                            <h1 class="font-weight-black text-12 mb-0 appear-animation" data-appear-animation="maskUp"
                                data-appear-animation-delay="1200">TUGAS & FUNGSI</h1>
                        </div>
                    </div>
        ...
        <div class="container pt-4 pb-5 mb-5">
            <div class="row">
                <div class="col">
                    ...
                    <p class="text-3-5">Badan Kesatuan Bangsa dan Politik mempunyai tugas pokok membantu Bupati dalam
                        penyelenggaraan pemerintahan daerah dibidang kesatuan bangsa dan politik.</p>
                </div>
            </div>
                    ...
                    <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="300">
                        ...
                        <ul class="list list-icons list-icons-style-2 list-icons-lg">
                            <li class="line-height-9 text-3-5 mb-1">
                                <i class="fas fa-check border-width-2 text-3"></i>Perumusan kebijakan teknis di bidang
                                kesatuan
                                bangsa dan politik di wilayah kabupaten sesuai dengan ketentuan peraturan
                                perundang-undangan.
                            </li>
                            <li class="line-height-9 text-3-5 mb-1">
                                <i class="fas fa-check border-width-2 text-3"></i>Pelaksanaan kebijakan di bidang
                                pembinaan
                            ...
                            <li class="line-height-9 text-3-5 mb-1">
                                <i class="fas fa-check border-width-2 text-3"></i>Pelaksanaan koordinasi di bidang
                                pembinaan
                                ideologi Pancasila dan wawasan kebangsaan, penyelenggaraan politik dalam negeri dan
                                kehidupan
                            ...
                            <li class="line-height-9 text-3-5 mb-1">
                                <i class="fas fa-check border-width-2 text-3"></i>Pelaksanaan evaluasi dan pelaporan di
                                bidang
                            ...
                            <li class="line-height-9 text-3-5 mb-1">
                                <i class="fas fa-check border-width-2 text-3"></i>Pelaksanaan fasilitasi forum
                                koordinasi
                                pimpinan daerah.
                            </li>
                            <li class="line-height-9 text-3-5 mb-1">
                                <i class="fas fa-check border-width-2 text-3"></i>Pelaksanaan administrasi
                                kesekretariatan badan
                                kesatuan bangsa dan politik Provinsi.
                            </li>
                            <li class="line-height-9 text-3-5 mb-1">
                                <i class="fas fa-check border-width-2 text-3"></i>Pelaksanaan tugas lain yang diberikan
                                oleh
