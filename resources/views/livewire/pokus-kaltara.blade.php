                ...
                <div class="tabs tabs-vertical tabs-left">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="overview" class="tab-pane {{ $activeTab === 'overview' ? 'active' : '' }}" role="tabpanel">
                            <div class="row mb-4">
                                <div class="col-12">
                                    <h3 class="font-weight-bold text-6 mb-3">Pusat Data Organisasi Kemasyarakatan</h3>
                                    <p class="text-4 mb-4">
                                        POKUS KALTARA merupakan pusat data terpadu untuk mengelola informasi organisasi kemasyarakatan 
                                        yang terdaftar di Provinsi Kalimantan Utara. Sistem ini menyediakan layanan registrasi, 
                                        pemantauan status, dan akses informasi publik terkait ORMAS.
                                    </p>
                                </div>
                            </div>
