<div class="col-span-12 gap-6 shadow rounded-lg border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark lg:col-span-6 2xl:col-span-3">
            <div class="col-span-6 border-b border-stroke px-3 py-1 dark:border-strokedark md:px-5 md:py-5 xl:px-5.5">
                ...
                <div>
                    <div class="flex items-center justify-between mt-5 mb-2">
                        <p class="text-slate-500 dark:text-zink-200">Count Aduan belum dibuka</p>
                    </div>
                ...
                <h6 class="mt-4 mb-3">Aduan Masuk</h6>
